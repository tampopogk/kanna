...
use super::artifacts::{
    ...
    push_artifact, record_artifact_comment, record_artifact_decision,
};
...
pub fn router(state: Arc<AppState>) -> Router {
    let router = Router::new()
        ...
        .route("/v1/repos/{repo_id}/doctor", get(doctor_repo))
        ...
        .route(
            "/v1/repos/{repo_id}/copilot-models",
            get(list_copilot_models),
        )
        .route(
        ...
        .route(
            "/v1/tasks/{task_id}/terminal-attempts",
            get(super::terminal_archives::list),
        )
        .route(
