...
fn control_response_id(response: &ControlResponse) -> &str {
    match response {
        ...
        | ControlResponse::ListPeerTaskTerminalAttempts { request_id, .. }
        | ControlResponse::ReadPeerTaskTerminalArchive { request_id, .. }
        ...
        | ControlResponse::NotifyTransferRefused { request_id }
