...
| T8 provenance | `d06e30e1` | first increment (channel identity capture); account boundary split to T8b | `task-482a02db-3` @ `9a4198da8` | increment 1 reviewed (round 2) + merged; combined check pending | `65e1943e5`, `7c06a0de4` | `a609c5aec` |
