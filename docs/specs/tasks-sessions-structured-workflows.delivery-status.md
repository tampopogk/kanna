...
| T8b same-account boundary | `216cf1c2` | account-boundary enforcement + T8 follow-ups (build-first, specialized-reviewers; build gate manual) | parent `e679678d0` (T6+T8 integrated) | in progress | — | — |
