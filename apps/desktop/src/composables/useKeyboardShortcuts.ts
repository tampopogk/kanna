...
export const shortcuts: ShortcutDef[] = [
  ...
  { action: "showAllShortcuts", labelKey: "shortcuts.allShortcuts",       groupKey: "shortcuts.groupAppHelp",   key: "/", code: "Slash",             meta: true, shift: true,  display: "⇧⌘/",     context: ["main", "file", "shell", "preview", "tree", "newTask"], hidden: true },
  { action: "showShortcuts",  labelKey: "shortcuts.keyboardShortcuts",  groupKey: "shortcuts.groupAppHelp",   key: "/", code: "Slash",             meta: true,               display: "⌘/",       context: ["main", "diff", "file", "shell", "preview", "tree", "graph", "newTask", "transfer"] },
