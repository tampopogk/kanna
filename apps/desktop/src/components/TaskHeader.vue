...
<template>
  <div class="task-header" @mousedown.prevent>
    ...
    <div class="header-meta">
      <span v-if="item.launchProvider" class="meta-item" title="Harness and native model recorded at stage launch. Changes made inside the harness TUI may differ.">Launched with {{ item.launchProvider }}{{ item.launchModel ? ` · ${item.launchModel}` : ' · CLI default' }}</span>
