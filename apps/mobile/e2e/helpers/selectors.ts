...
export const selectors = {
  ...
  accountVerificationState: `~${MOBILE_E2E_IDS.accountVerificationState}`,
  accountSubscriptionState: `~${MOBILE_E2E_IDS.accountSubscriptionState}`,
  accountEntitledState: `~${MOBILE_E2E_IDS.accountEntitledState}`,
  appleBillingCard: `~${MOBILE_E2E_IDS.appleBillingCard}`,
  appleBillingUnconfirmed: `~${MOBILE_E2E_IDS.appleBillingUnconfirmed}`,
  appleBillingSource(source: string): string {
    return `~${MOBILE_E2E_IDS.appleBillingSource(source)}`;
  },
  appleBillingPrice: `~${MOBILE_E2E_IDS.appleBillingPrice}`,
  appleBillingSubscribeButton: `~${MOBILE_E2E_IDS.appleBillingSubscribeButton}`,
  appleBillingRestoreButton: `~${MOBILE_E2E_IDS.appleBillingRestoreButton}`,
